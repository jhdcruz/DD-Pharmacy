...
import com.inventory.Controllers.SupplierController;
...
public class SupplierPage extends javax.swing.JPanel {
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        if (codeText.getText().equals("") || nameText.getText().equals("")
            ...
            new SupplierController().addSupplierDAO(supplierModel);
            loadDataSet();
        }
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        if (suppTable.getSelectedRow()<0)
            ...
            if (codeText.getText().equals("") || nameText.getText().equals("")
                ...
                supplierModel.setLocation(locationText.getText());
                supplierModel.setPhone(phoneText.getText());
                new SupplierController().editSupplierDAO(supplierModel);
                loadDataSet();
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        if (suppTable.getSelectedRow()<0)
            ...
            if (opt==JOptionPane.YES_OPTION) {
                new SupplierController().deleteSupplierDAO(suppTable.getValueAt(suppTable.getSelectedRow(),0).toString());
                loadDataSet();
            }
        }
    ...
    public void loadDataSet() {
        try {
            ...
            suppTable.setModel(supplierController.buildTableModel(supplierController.getQueryResult()));
    ...
    public void loadSearchData(String text) {
        try {
            SupplierController supplierController = new SupplierController();
            suppTable.setModel(supplierController.buildTableModel(supplierController.getSearchResult(text)));
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
